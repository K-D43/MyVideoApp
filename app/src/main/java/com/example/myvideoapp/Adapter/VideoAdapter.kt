package com.example.myvideoapp.Adapter
...
import com.example.myvideoapp.databinding.VideoViewBinding
...
class VideoAdapter(private val context: Context,private var videoList:ArrayList<Video>):RecyclerView.Adapter<VideoAdapter.MyHolder>() {
    ...
    override fun onBindViewHolder(holder: MyHolder, position: Int) {
        ...
        holder.duration.text=DateUtils.formatElapsedTime(videoList[position].duration)
    }
